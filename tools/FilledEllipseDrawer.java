...
public class FilledEllipseDrawer extends EllipseDrawer {

	static public AbstractTool tool = null;

	public FilledEllipseDrawer(MainWindow main) {
		super(main);
		toolName = "Wypelnione Elipsy";
	}

	static public AbstractTool getTool(MainWindow main) {
		if (tool == null)
			tool = new FilledEllipseDrawer(main);
		return tool;
	}
